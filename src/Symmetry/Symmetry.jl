...
function Symmetry{T}(symmetry_type::AbstractString, config_dict::AbstractDict, units::NamedTuple) where T
...
function Symmetry{T}(symmetry_types::AbstractArray, config_dicts::AbstractArray, units::NamedTuple) where T
...
function Symmetry{T}(config_file_dict::AbstractDict, units::NamedTuple)::NamedTuple where T
    nt = NamedTuple()
