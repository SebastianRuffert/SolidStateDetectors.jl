...
const SSD_examples = Dict{Symbol,String}([
    ...
    :TestDetectorCart                        => joinpath(get_path_to_example_config_files(), "test_geometry/cartesian_test_geometry.yaml"),
    :TestDetectorCyl                         => joinpath(get_path_to_example_config_files(), "test_geometry/cylindrical_test_geometry.yaml"),
])
